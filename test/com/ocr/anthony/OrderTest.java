...
public class OrderTest {
    ...
    @Test
    public void Given_StillWater_When_DisplayDrinkSelected_Then_DisplayStillWaterSentence() {
    ...
    @Test
    public void Given_BadValue_When_DisplayDrinkSelected_Then_DisplayBadValueSentence() {
    ...
    public void Given_ChikenWithBadSideAndBadDrink_When_MenuIsRun_Then_ReAskSideAndDrink() {
        ...
        assertEquals("Vous avez choisi comme accompagnement : frites", output[12]);
        assertEquals("Vous n'avez pas choisi de boisson parmi celles proposées", output[18]);
    ...
    public void Given_VegetarianWithBadSideAndBadDrink_When_MenuIsRun_Then_ReAskSideAndDrink() {
        ...
        assertEquals("Vous n'avez pas choisi de boisson parmi celles proposées", output[17]);
        assertEquals("Vous avez choisi comme boisson : soda", output[18]);
    }
}